...
# Render/Heroku נותנות URL כמו postgres:// -> צריך להמיר ל-postgresql://
...
def recompute_chain_in_db():
    """מסיים רצות שעבר זמנן ומפעיל אוטומטית את הבאה (pending)."""
